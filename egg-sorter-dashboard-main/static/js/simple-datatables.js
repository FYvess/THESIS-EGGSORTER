          ...
          (function (global) {
            (function () {
                ...
                switch (o) {
                  ...
                  case s._const.modifyTextElement:
                    ...
                    s.textDiff(
                      ...
                      m(i.parentNode, "HTMLTextAreaElement") &&
                  ...
                  case s._const.relocateGroup:
                    p([], new Array(e[s._const.groupLength]), !0)
                      .map(function () {
                  ...
                  case s._const.removeTextElement:
                    ...
                    var h = i.parentNode;
                    h.removeChild(i),
                      m(h, "HTMLTextAreaElement") && (h.value = "");
                    break;
              ...
              function T(t, e) {
                ...
                if (m(t, "Text", "Comment")) s.data = t.data;
                else {
                  ...
                  e.valueDiffing &&
                    (m(t, "HTMLTextAreaElement") && (s.value = t.value),
                    m(t, "HTMLInputElement") &&
                    ...
                    m(t, "HTMLOptionElement") && (s.selected = t.selected));
                }
                return s;
              }
              var A =
              ...
              var R = {
                ...
                Y = (function () {
                  function t(t, e, s) {
                    (this.options = s),
                      (this.t1 =
                        "undefined" != typeof Element && m(t, "Element")
                          ? T(t, this.options)
                          : "string" == typeof t
                          ? I(t, this.options)
                          : JSON.parse(JSON.stringify(t))),
                      (this.t2 =
                        "undefined" != typeof Element && m(e, "Element")
                          ? T(e, this.options)
                          : "string" == typeof e
                          ? I(e, this.options)
              ...
              const q = (
                ...
                B = (
                  ...
                  { noColumnWidths: v, unhideHeader: _, renderHeader: w },
                  y,
                  M
                ) => {
                  const D = {
                  ...
                  if (
                    ((D.attributes.class = c(D.attributes.class, r.table)),
                    d || h || w)
                  ) {
                    const t = q(
                      e,
                      ...
                      { noColumnWidths: v, unhideHeader: _ }
                    );
                    if (d || w) {
                  ...
                  return (
                    ...
                    M.forEach((t) => D.childNodes.push(t)),
                    !1 !== b && (D.attributes.tabindex = String(b)),
                    D
                  );
                };
              ...
              const X = (t, e) => {
                ...
                K = (t, e = void 0, s, n, a) => {
                  ...
                  if (t.headings) o.headings = t.headings.map((t) => G(t));
                  else if (e?.tHead)
                  ...
                  if (t.data) {
                    ...
                    o.data = t.data.map((t) => {
                      ...
                      return (
                        ...
                        { attributes: i, cells: n.map((t, e) => Z(t, s[e])) }
                      );
                    });
                  } else
                    e?.tBodies?.length &&
              ...
              class et {
                ...
                sort(t, e = void 0, s = !1) {
                  ...
                  this.dt.data.data.sort((s, i) => {
                    ...
                    return a && "number" != typeof l && "number" != typeof d
              ...
              const st = {
                ...
                nt = (t, e, s, i, n) => {
                  let a = [];
                  if (
                    (n.firstLast && a.push(it(1, n.firstText, n)), n.nextPrev)
                  ) {
                    const e = t ? 1 : s - 1;
                    a.push(it(e, n.prevText, n, { hidden: t }));
                  }
                  let o = [...Array(i).keys()].map((t) =>
                    it(t + 1, String(t + 1), n, { active: t === s - 1 })
                  );
                  if (
                    (n.truncatePager &&
                      (o = ((t, e, s, i) => {
                    ...
                    const t = e ? i : s + 1;
                    a.push(it(t, n.nextText, n, { hidden: e }));
                  }
              ...
              (exports.DataTable = class {
                ...
                constructor(t, e = {}) {
                  ...
                  const i = { ...st.diffDomOptions, ...e.diffDomOptions },
                    n = { ...st.labels, ...e.labels },
                    a = { ...st.classes, ...e.classes };
                  (this.options = {
                    ...st,
                    ...e,
                    diffDomOptions: i,
                ...
                init() {
                  ...
                  (this._virtualDOM = T(
                    ...
                    (this.rows = new tt(this)),
                    (this.columns = new et(this)),
                    (this.data = K(
                      this.options.data,
                      this.dom,
