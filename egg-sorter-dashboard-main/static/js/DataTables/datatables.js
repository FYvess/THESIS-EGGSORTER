 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/moment-2.29.4/dt-2.3.0/date-1.5.5
 *
 * Included libraries:
 *   jQuery 3.7.0, Moment 2.29.4, DataTables 2.3.0, DateTime 1.5.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/jq-3.7.0/moment-2.29.4/dt-2.3.0/date-1.5.5",
